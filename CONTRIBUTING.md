...
While Glucose-ML is not an open-contribution repository for direct code or data integration, we actively welcome the **submission of new CGM datasets** for consideration.

This document describes how you can submit a dataset request to us and how these datasets are integrated into the Glucose-ML collection.
