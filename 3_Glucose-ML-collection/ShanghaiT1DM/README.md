# ShanghaiT1DM
The [Glucose-ML Project](https://www.glucose-ml-project.com/) curates and harmonizes public CGM datasets and associated metadata for research. This directory contains the harmonized glucose data and metadata for the *ShanghaiT1DM* dataset.
...
3. `ShanghaiT1DM-from-Glucose-ML.zip`: This zip file contains the harmonized glucose data (`ShanghaiT1DM-extracted-glucose-files/`), metadata (`ShanghaiT1DM_metadata.csv`), and this README for the ShanghaiT1DM dataset and is included so the user can download the data directly from our GitHub repository.
