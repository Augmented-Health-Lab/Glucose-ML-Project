# Park_2025
The Glucose-ML Project curates and harmonizes CGM data and associated metadata from various datasets in the collection. This directory contains the harmonized glucose data and metadata for the *Park_2025* dataset.
...
3. `Park_2025-from-Glucose-ML.zip`: This zip file contains the harmonized glucose data (`Park_2025-extracted-glucose-files/`) and metadata (`Park_2025_metadata.csv`) for the Park_2025 dataset and is included so the user can download the data directly from our GitHub repository.
