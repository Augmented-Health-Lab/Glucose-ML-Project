...
**License Details**
- This dataset is distributed under a custom data use license developed by the AI-READI project. Full license details are available for the 3.0.0 version here: https://doi.org/10.5281/zenodo.17555036
