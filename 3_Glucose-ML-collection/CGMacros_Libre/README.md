# CGMacros_Libre
The [Glucose-ML Project](https://www.glucose-ml-project.com/) curates and harmonizes public CGM datasets and associated metadata for research. This directory contains the harmonized glucose data and metadata for the *CGMacros_Libre* dataset.
...
3. `CGMacros_Libre-from-Glucose-ML.zip`: This zip file contains the harmonized glucose data (`CGMacros_Libre-extracted-glucose-files/`), metadata (`CGMacros_Libre_metadata.csv`), and this README for the CGMacros_Libre dataset and is included so the user can download the data directly from our GitHub repository.
