...
1. Request access and download the T1DiabetesGranada dataset from the original data source (https://zenodo.org/records/10050944).
2. Place the download contents in `1_Auto-scripts/Original-Glucose-ML-datasets/T1DiabetesGranada_raw_data/` (Make the directory, if needed.)
...
```
5. Harmonized csv files are written to: `Standardized-datasets/T1DiabetesGranada/<subject_id>.csv`
