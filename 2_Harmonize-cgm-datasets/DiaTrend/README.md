...
1. Request access and download the DiaTrend dataset from the original data source (https://doi.org/10.7303/syn38187184).
2. Place the download contents in `1_Auto-scripts/Original-Glucose-ML-datasets/DiaTrend_raw_data/` (Make the directory, if needed.)
...
```
5. Harmonized csv files are written to: `Standardized-datasets/DiaTrend/<subject_id>.csv`
