...
1. Request access and download the AI-READI dataset from the original data source (https://fairhub.io/datasets/3). If the download is a zipped file, DO NOT UNZIP.
2. Place the unzipped download in `1_Auto-scripts/Original-Glucose-ML-datasets/AI-READI_raw_data/` (Make the directory, if needed.)
...
```
4. Harmonized csv files are written to: `Standardized-datasets/AI-READI/<subject_id>.csv`
