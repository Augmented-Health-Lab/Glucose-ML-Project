...
1. Download the T1D-UOM dataset from the original data source (https://zenodo.org/records/15806142) or use our auto_download scripts [here](../../1_Auto-scripts). If the download is a zipped file, DO NOT UNZIP.
2. Place the unzipped download in `1_Auto-scripts/Original-Glucose-ML-datasets/T1D-UOM_raw_data/` (Make the directory, if needed.)
...
```
4. Harmonized csv files are written to: `Standardized-datasets/T1D-UOM/<subject_id>.csv`
