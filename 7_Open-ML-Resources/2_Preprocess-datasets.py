...
def process_files(project_df, extracted_glucose_file_path, project, minimum_coverage):
    ...
    - Saves processed datasets to "Open-ML-Ready-Datasets/"
    - Generates a summary manifest file to "Open-ML-Ready-Datasets/"
    ...
    for i, row in project_df.iterrows():
        ...
        out_folder = Path("Open-ML-Ready-Datasets") / dataset
...
def main():
    ...
    Output: 
        ...
        - Open-ML-Ready-Datasets/[datasets]
    ...
    manifest_df.to_csv("Open-ML-Ready-Datasets/preprocessing_manifest.csv", index=False)
