...
def main():
    '''
    This script accesses the metadata for specified datasets and splits the data by Diabetes status and
    applies a test-train-validate split on each diabetes population.
